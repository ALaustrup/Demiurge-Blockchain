    ...
    try {
      ...
      const realTasks: DailyTask[] = [
        ...
        },
        {
          ...
          reward: 200,
          completed: todayActivity.some(a => a.type === 'game'),
          progress: todayActivity.filter(a => a.type === 'game').length,
          maxProgress: 1,
          link: '/games',
        },
        {
          ...
          reward: 500,
          completed: todayActivity.some(a => a.type === 'game' && a.description?.toLowerCase().includes('win')),
          progress: todayActivity.filter(a => a.type === 'game' && a.description?.toLowerCase().includes('win')).length,
          maxProgress: 1,
          link: '/games',
        },
        {
