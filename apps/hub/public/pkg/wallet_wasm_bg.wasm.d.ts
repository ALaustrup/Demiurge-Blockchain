...
export const generate_keypair_from_seed: (a: number, b: number) => [number, number, number, number];
export const generate_random_keypair: () => [number, number, number, number];
export const get_address_from_keypair: (a: number, b: number) => [number, number, number, number];
