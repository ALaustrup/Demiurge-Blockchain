 ...
 * @returns {string}
 */
export function generate_keypair_from_seed(seed) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(seed, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.generate_keypair_from_seed(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function get_address_from_keypair(keypair_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(keypair_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_address_from_keypair(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function sign_message(keypair_json, message) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(keypair_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {boolean}
 */
export function verify_signature(public_key_hex, message, signature_hex) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_alert_5bde9552573947f1 = function(arg0, arg1) {
